    ...
    @autoreleasepool
    {
        ...
        for (NSDictionary *item in items)
        {
            ...
            for (NSDictionary *comment in comments)
            {
                ...
                NSXMLNode *messageNode = [[NSXMLNode alloc] initWithKind:NSXMLTextKind  options:NSXMLNodeIsCDATA];
                [messageNode setStringValue:FilterString(SAFESTR(comment[@"message"]))];
                NSXMLElement *contentElement = [[NSXMLElement alloc] initWithName:@"wp:comment_content"];
                [contentElement addChild:messageNode];
                
                [commentNode addChild:contentElement];
